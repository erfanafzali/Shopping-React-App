  ...
  return (
    <div className="w-full flex justify-between items-center md:pb-5">
      <img
        src={data.image}
        alt={data.title}
        className="rounded-xl md:max-w-[300px] max-w-[200px] w-[50px]  md:w-[110px]  md:max-h-[60px] max-h-[50px] "
      />
      <p className="text-xs font-bold text-white md:text-lg"> {shortenText(data.title)}</p>
